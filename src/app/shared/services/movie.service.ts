...
const options={
  ...
  headers: {
    ...
    Authorization: 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI1ZWJmZWM2NWFjNGZlMzYwNWZkZGFmNTZlODA0MDcyNiIsIm5iZiI6MTcyOTc0NDU4NS4wNjk5NDEsInN1YiI6IjY3MThlYWFjNDI3YzVjMTlmMDI1OWQ1NSIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.bdrjB9q8M-3TiXltJ0LON_DetU96kbe7lz3I8TNW5Bk'
  }
}
@Injectable({
  providedIn: 'root'
